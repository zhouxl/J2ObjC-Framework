...
/*!
 @brief Determines whether a character is a BMP digit according to definition
...
/*!
 @brief Determines whether a character is a BMP letter according to definition
...
/*!
 @brief Determines whether a character is a BMP letter or digit according to definition
 .
...
/*!
 @brief Determines whether a BMP character is lower case according to definition
 .
...
/*!
 @brief Determines whether a BMP character is upper case according to definition
 .
...
@endcode
 ...
 <p><b>Note:</b> If the replacement is a fixed string with only one character, you are better
  off calling <code>char)</code> directly.
 @param sequence the character sequence to replace matching characters in
...
/*!
 @brief Determines whether a character is a digit according to 
 definition.If you only care to match
...
/*!
 ...
 definition.If you only care to
