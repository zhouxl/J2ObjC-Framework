...
/*!
 @brief If the argument is an ASCII character returns the
  lowercase equivalent.Otherwise returns the argument.
 */
+ (jchar)toLowerCaseWithChar:(jchar)c;

/*!
 @brief Returns a copy of the input character sequence in which all ASCII characters
...
/*!
 @brief Returns a copy of the input string in which all ASCII
  characters
...
/*!
 @brief If the argument is a ASCII character returns the
