...
/*!
 ...
 <p>This method is equivalent to <code>fuzzyEquals(a, b, tolerance) ? 0 : Double.compare(a,
  b)</code>
 . In particular, like <code>double)</code>, it treats all NaN values as
...
/*!
 ...
 <p>If the result of this method will be immediately rounded to an <code>int</code>, <code>RoundingMode)</code>
  is faster.
 */
