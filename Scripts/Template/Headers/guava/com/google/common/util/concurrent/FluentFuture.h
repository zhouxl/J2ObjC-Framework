...
@endcode
 ...
 <p>This method is similar to <code>java.util.concurrent.CompletableFuture</code> and 
 <code>java.util.concurrent.CompletableFuture</code>. It also serves the use case
  of <code>java.util.concurrent.CompletableFuture</code> and <code>java.util.concurrent.CompletableFuture</code>
 .
...
@endcode
 ...
 <p>This method is similar to <code>java.util.concurrent.CompletableFuture</code>. It
  can also serve some of the use cases of <code>java.util.concurrent.CompletableFuture</code>
  and <code>java.util.concurrent.CompletableFuture</code> when used along with <code>transform</code>
 .
...
@endcode
 ...
 <p>An example use of this method is to convert a serializable object returned from an RPC into
  a POJO. 
 <p>This method is similar to <code>java.util.concurrent.CompletableFuture</code> and 
 <code>java.util.concurrent.CompletableFuture</code>. It can also serve some of the
  use cases of <code>java.util.concurrent.CompletableFuture</code> and <code>java.util.concurrent.CompletableFuture</code>
