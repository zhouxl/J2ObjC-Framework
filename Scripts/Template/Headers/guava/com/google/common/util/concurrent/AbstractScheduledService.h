...
/*!
 ...
 <p>By default this returns a new <code>ScheduledExecutorService</code> with a single thread thread
  pool that sets the name of the thread to the name. Also,
  the pool will be down when the service 
 terminates or fails
 .
 */
...
/*!
 @brief Run one iteration of the scheduled task.If any invocation of this method throws an exception,
  the service will transition to the <code>Service.State</code> state and this method will no
  longer be called.
 */
