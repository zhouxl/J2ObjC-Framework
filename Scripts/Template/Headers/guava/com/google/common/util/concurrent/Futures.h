...
/*!
 @brief Returns the result of <code>TimeUnit)</code>, converting most exceptions to a new
...
/*!
 @brief Like <code>Function, Executor)</code> except that the transformation 
 ...
 <p>Note that calls to get only apply the timeout
...
/*!
 @brief Like <code>Executor)</code> but using executor
 .
 */
