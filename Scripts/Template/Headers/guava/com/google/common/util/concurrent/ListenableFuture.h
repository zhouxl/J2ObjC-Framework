...
@endcode
 ...
 <p>We encourage you to return <code>ListenableFuture</code> from your methods so that your users can
  take advantage of the built atop the class. The way that you will
 ...
 .
    <li>If you manually call <code>java.util.concurrent.FutureTask</code> or a similar method,
...
/*!
 ...
 <p>Exceptions thrown by a listener will be propagated up to the executor. Any exception thrown
  ...
  thrown by execution) will be caught and
  logged. 
