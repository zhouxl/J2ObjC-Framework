...
/*!
 @brief <p>If a cancellation attempt succeeds on a <code>Future</code> that had previously been asynchronously
...
/*!
 @brief Sets the result of this <code>Future</code> unless this <code>Future</code> has already been cancelled or
  set (including asynchronously).When a call to this method returns,
...
/*!
 @brief Sets the failed result of this <code>Future</code> unless this <code>Future</code> has already been
  cancelled or set (including asynchronously).When a call to this
