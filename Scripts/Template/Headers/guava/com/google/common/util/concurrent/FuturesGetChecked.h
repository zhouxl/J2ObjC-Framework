...
/*!
 @brief Static methods used to implement <code>Class)</code>.
 */
...
/*!
 @brief Implementation of <code>Class, long, TimeUnit)</code>.
 */
+ (id)getCheckedWithJavaUtilConcurrentFuture:(id<JavaUtilConcurrentFuture>)future
                                withIOSClass:(IOSClass *)exceptionClass
...
/*!
 @brief Implementation of <code>Class)</code>.
 */
...
/*!
 @brief Provides a check of whether an exception type is valid for use with <code>Class)</code>
