...
/*!
 @brief A semi-persistent mapping from keys to values.Cache entries are manually added using <code>Callable)</code>
  or <code>Object)</code>, and are stored in the cache until either
...
/*!
 ...
 <ul>
    <li>the result of a pending load rather than
 ...
 <ul>
    <li>consolidation of the loader logic to single
        authoritative location
    <li>of entries, including refreshing
    <li>loading requests, including loading implementations
  </ul>
...
/*!
 ...
 <p>Prefer <code>Callable)</code> when using the conventional "if cached, return;
