...
/*!
 ...
 <p>If this network <code>parallel edges</code>, parallel edges will be
...
/*!
 @brief Returns true if the edges in this network are directed.Directed edges connect a <code>node</code>
...
/*!
 @brief Returns the edges whose <code>nodes</code> in this network include 
 <code>node</code>.
 @throw IllegalArgumentExceptionif <code>node</code> is not an element of this network
 */
...
/*!
 @brief Returns the count of <code>node</code>'s <code>edges</code>, counting
...
/*!
 @brief Returns the count of <code>node</code>'s <code>edges</code> in a directed
...
/*!
 @brief Returns the edges which have an <code>node</code> in common with 
...
/*!
 ...
 <p>The resulting set of edges will be parallel (i.e. have equal <code>incidentNodes(Object)</code>.
  If this network does not <code>parallel edges</code>, the resulting set
...
/*!
 ...
 <ul>
    ...
    <li>A and B have equal <code>sets</code>.
    <li>A and B have equal <code>sets</code>.
...
/*!
 @brief Returns the hash code for this network.The hash code of a network is defined as the hash code
  of a map from each of its <code>edges</code> to their <code>nodes</code>
 .
