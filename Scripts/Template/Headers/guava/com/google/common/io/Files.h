...
/*!
 ...
 <p><b><code>java.nio.file.Path</code> equivalent:</b> <code>java.nio.file.Files</code>
 .
 @param from the source file
 @param to the destination file
 @throw IOExceptionif an I/O error occurs
...
/*!
 ...
 <p>Use this method instead of <code>String)</code> when you wish to
...
/*!
 @brief Fully maps a file read-only in to memory as per <code>long, long)</code>
 .
...
/*!
 @brief Fully maps a file in to memory as per <code>long, long)</code>
...
/*!
 @brief Maps a file in to memory as per <code>long, long)</code>
  using the requested <code>MapMode</code>.
