...
/*!
 ...
 lexicographically</a>.That is, it
  compares, using <code>double)</code>), the first pair of values that follow any
 ...
 <p>The returned comparator is inconsistent with <code>Object.equals(Object)</code> (since arrays
  support only identity equality), but it is consistent with <code>double[])</code>
 .
 @since 2.0
 */
...
/*!
 @brief Returns the least value present in <code>array</code>, using the same rules of comparison as <code>double)</code>
 .
 @param array a  <i> nonempty </i>  array of <code>double</code>  values
