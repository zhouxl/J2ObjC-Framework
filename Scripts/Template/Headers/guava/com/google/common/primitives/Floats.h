...
/*!
 @brief Compares the two specified <code>float</code> values using <code>float)</code>.You
 ...
 @return the result of invoking <code>float)</code>
 */
...
/*!
 ...
 lexicographically</a>.That is, it
  compares, using <code>float)</code>), the first pair of values that follow any
 ...
 <p>The returned comparator is inconsistent with <code>Object.equals(Object)</code> (since arrays
  support only identity equality), but it is consistent with <code>float[])</code>
 .
 @since 2.0
 */
...
/*!
 @brief Returns the least value present in <code>array</code>, using the same rules of comparison as <code>float)</code>
 .
 @param array a  <i> nonempty </i>  array of <code>float</code>  values
