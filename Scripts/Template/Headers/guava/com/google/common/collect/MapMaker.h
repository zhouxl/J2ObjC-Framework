...
@endcode
 ...
 <p>If <code>weakKeys</code> or <code>weakValues</code> are requested, it is possible for a key or value
  ...
  instance retrieved from the map's set is a snapshot of that
  entry's state at the time of retrieval; such entries do, however, support <code>java.util.Entry</code>
...
/*!
 ...
 <p><b>Warning:</b> when this method is used, the resulting map will use identity (<code>==</code>)
  ...
  methods <code>containsValue</code>, <code>Object)</code>
  and <code>V,
  V)</code>
