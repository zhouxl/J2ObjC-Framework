...
/*!
 @brief Returns the last element of the specified stream, or <code>java.util.Optional</code> if the
  stream is empty.
 <p>Equivalent to <code>stream.reduce((a, b) -> b)</code>, but may perform significantly better. This
  method's runtime will be between O(log n) and O(n), performing better on <a href="http://gee.cs.oswego.edu/dl/html/StreamParallelGuidance.html">
 efficiently splittable</a>
...
/*!
 ...
 <p>This interface is only intended for use by callers of <code>FunctionWithIndex)</code>
 .
 @since 21.0
 */
...
/*!
 ...
 <p>This interface is only intended for use by callers of <code>IntFunctionWithIndex)</code>
 .
 @since 21.0
 */
...
/*!
 ...
 <p>This interface is only intended for use by callers of <code>LongFunctionWithIndex)</code>
 .
 @since 21.0
 */
...
/*!
 ...
 <p>This interface is only intended for use by callers of <code>DoubleFunctionWithIndex)</code>
 .
 @since 21.0
 */
