...
/*!
 @brief A sensible definition of <code>putAll(Map)</code> in terms of <code>Object)</code>.If you
  override <code>Object)</code>, you may wish to override <code>putAll(Map)</code> to forward
