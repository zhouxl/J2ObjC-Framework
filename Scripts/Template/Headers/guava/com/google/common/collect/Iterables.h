...
/*!
 @brief Returns the first element in <code>iterable</code> that satisfies the given predicate; use this
  ...
  will match, use <code>tryFind</code> or <code>Predicate, Object)</code> instead.
...
/*!
 ...
 . If <code>element</code> might be null, use <code>stream.filter(Predicate.isEqual(element)).count()</code>
  instead.
 - seealso: java.util.CollectionsCollections.frequency(Collection,
      Object)
 */
...
/*!
 ...
 <p><b>Note:</b> if <code>iterable</code> is a <code>List</code>, use <code>int)</code>
  instead.
 @param iterable the iterable to return a partitioned view of
