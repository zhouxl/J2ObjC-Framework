...
/*!
 @brief Reads a count corresponding to a serialized map, multiset, or multimap.It returns the size of
  a map serialized by <code>ObjectOutputStream)</code>, the number of distinct elements
  in a multiset serialized by <code>ObjectOutputStream)</code>, or the number
  of distinct keys in a multimap serialized by <code>ObjectOutputStream)</code>
 .
 */
