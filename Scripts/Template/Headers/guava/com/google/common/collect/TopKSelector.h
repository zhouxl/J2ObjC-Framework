...
/*!
 ...
 <p>If your input data is available as a <code>Stream</code>, prefer passing <code>Comparators.least(int)</code>
  ...
  as an <code>Iterable</code> or <code>Iterator</code>, prefer <code>int)</code>.
  
 <p>This uses the same efficient implementation as <code>int)</code>,
...
/*!
 ...
 <code>int)</code>, which provides a simpler API for that use case.
 */
