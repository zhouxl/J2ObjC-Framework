...
/*!
 @brief A sensible definition of <code>ceiling</code> in terms of the <code>iterator</code> method of <code>boolean)</code>
 .If you override <code>boolean)</code>, you may wish to
...
/*!
 ...
 <code>boolean)</code>.If you override <code>boolean)</code>, you may
  wish to override <code>floor</code> to forward to this implementation.
 */
- (id)standardFloorWithId:(id)e;

/*!
 @brief A sensible definition of <code>headSet(Object)</code> in terms of the <code>boolean)</code>
  method.If you override <code>boolean)</code>, you may wish to override 
 <code>headSet(Object)</code> to forward to this implementation.
 */
- (id<JavaUtilSortedSet>)standardHeadSetWithId:(id)toElement;

/*!
 @brief A sensible definition of <code>higher</code> in terms of the <code>iterator</code> method of <code>boolean)</code>
 .If you override <code>boolean)</code>, you may wish to
...
/*!
 @brief A sensible definition of <code>boolean, Object, boolean)</code> in terms of the 
 <code>headSet</code> and <code>tailSet</code> methods.In many cases, you may wish to override <code>boolean, Object, boolean)</code>
...
/*!
 @brief A sensible definition of <code>Object)</code> in terms of the <code>boolean, Object, boolean)</code>
  method.If you override <code>boolean, Object,
 boolean)</code>
 , you may wish to override <code>Object)</code> to forward to this
  implementation.
 */
...
/*!
 @brief A sensible definition of <code>tailSet(Object)</code> in terms of the <code>boolean)</code>
  method.If you override <code>boolean)</code>, you may wish to override 
