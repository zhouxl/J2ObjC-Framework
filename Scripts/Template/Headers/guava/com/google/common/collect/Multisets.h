...
/*!
 ...
 , which is inconsistent with equals. (See <code>Class)</code>
...
/*!
 @brief An implementation of <code>int, int)</code>.
 */
...
/*!
 @brief Indicates whether an object equals this entry, following the behavior specified in <code>Multiset.Entry</code>
 .
 */
- (jboolean)isEqual:(id __nullable)object;

/*!
 @brief Return this entry's hash code, following the behavior specified in <code>Multiset.Entry</code>
 .
 */
- (NSUInteger)hash;
