...
/*!
 ...
 <code>Comparator)</code> method), prior to
  making this call.
...
/*!
 @brief Searches the specified naturally ordered list for the specified object using the binary search
  algorithm.
 <p>Equivalent to <code>Function, Object, Comparator, KeyPresentBehavior,
...
/*!
 ...
 <p>Equivalent to <code>Object, Comparator, KeyPresentBehavior,
 KeyAbsentBehavior)</code>
  using <code>keyFunction)</code>
 .
 */
+ (jint)binarySearchWithJavaUtilList:(id<JavaUtilList>)list
...
/*!
 ...
 <p>This is equivalent to the behavior of <code>java.util.Collections</code>
