...
/*!
 ...
 <p><b>Warning:</b> The methods of <code>ForwardingMultiset</code> forward <b>indiscriminately</b> to
  the methods of the delegate. For example, overriding <code>int)</code> alone <b>will
...
/*!
 @brief A sensible definition of <code>add(Object)</code> in terms of <code>int)</code>.If you
  override <code>int)</code>, you may wish to override <code>add(Object)</code> to forward to
  this implementation.
 @since 7.0
 */
...
/*!
 ...
 <code>int)</code>.If you override either of these methods, you may wish to override 
...
/*!
 @brief A sensible definition of <code>remove(Object)</code> in terms of <code>int)</code>.If
  you override <code>int)</code>, you may wish to override <code>remove(Object)</code> to
  forward to this implementation.
 @since 7.0
 */
...
/*!
 @brief A sensible definition of <code>int)</code> in terms of <code>count(Object)</code>,
  <code>int)</code>, and <code>int)</code>.
 <code>entrySet()</code>. If you
  override any of these methods, you may wish to override <code>int)</code> to
  forward to this implementation.
 @since 7.0
 */
...
/*!
 @brief A sensible definition of <code>int, int)</code> in terms of <code>count(Object)</code>
  and <code>int)</code>.If you override either of these methods, you may wish to override 
 <code>int, int)</code> to forward to this implementation.
 @since 7.0
 */
