...
/*!
 ...
 Otherwise, the specified collection must contain at least one
  element, in order to determine the element type. If the collection could be empty, use <code>Class)</code>
...
/*!
 ...
 <code>Enum</code> type, use <code>Enum[])</code> instead. Otherwise, strongly consider
  using a <code>LinkedHashSet</code> instead, at the cost of increased memory footprint, to get
  deterministic iteration behavior. 
...
/*!
 ...
 <p><b>Note:</b> if <code>E</code> is an <code>Enum</code> type, use <code>Class)</code>
  instead. 
